      ...
      <div className='flex flex-wrap justify-center md:justify-between mt-10 gap-20'>
        {services.map((service) => (
          <Link passHref key={service.id} href={`/products/${service.name}`}>
            <div className='w-[245px] h-[245px] sm:w-[500px] sm:h-[500px] flex justify-center items-center p-2 sm:p-4 bg-gray-200 mb-10 relative group rounded js-show-on-scroll'>
